...
type User struct {
	...
	// PrimaryTenantID holds the value of the "primary_tenant_id" field.
...
func (e UserEdges) MembershipsOrErr() ([]*TenantMembership, error) {
	if e.loadedTypes[0] {
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldPrimaryTenantID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field primary_tenant_id", values[i])
			} else if value.Valid {
				_m.PrimaryTenantID = value.String
			}
		case user.FieldProfile:
...
func (_m *User) QueryMemberships() *TenantMembershipQuery {
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("primary_tenant_id=")
	builder.WriteString(_m.PrimaryTenantID)
	builder.WriteString(", ")
