...
func (_q *UserQuery) QueryMemberships() *TenantMembershipQuery {
...
func (_q *UserQuery) WithMemberships(opts ...func(*TenantMembershipQuery)) *UserQuery {
	query := (&TenantMembershipClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *User) { n.Edges.Memberships = []*TenantMembership{} },
			func(n *User, e *TenantMembership) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
...
func (_q *UserQuery) loadMemberships(ctx context.Context, query *TenantMembershipQuery, nodes []*User, init func(*User), assign func(*User, *TenantMembership)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tenantmembership.FieldUserID)
	}
