...
func (*OAuthClient) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case oauthclient.FieldRedirectUris, oauthclient.FieldAllowedScopes, oauthclient.FieldMetadata:
			values[i] = new([]byte)
		case oauthclient.FieldPublic:
			values[i] = new(sql.NullBool)
		case oauthclient.FieldClientID, oauthclient.FieldClientSecret, oauthclient.FieldName, oauthclient.FieldTenantID:
